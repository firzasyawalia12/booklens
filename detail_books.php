...
// 2. Tangkap ID dari URL (?id=), jika kosong default ke ID 4 (Pukul Setengah Lima) agar sesuai contoh visual awal
$id_buku = isset($_GET['id']) ? intval($_GET['id']) : 4;

// 3. Database internal simulasi 6 buku sesuai kirimanmu
$database_buku = [
    1 => [
        "title" => "Hujan",
        "author" => "Tere Liye",
...
// 4. Database internal review khusus untuk masing-masing ID Buku
$database_reviews = [
    1 => [
    ...
    4 => [
        ["user" => "Andi Thsabitha Hulwa", "date" => "Juni 07, 2026", "stars" => 5, "text" => "Bakalan mantau sampe end"],
        ["user" => "Refina Indah Rahmawati", "date" => "Juni 07, 2026", "stars" => 5, "text" => "Bakalan mantau sampe end"],
        ["user" => "User Name", "date" => "Juni 07, 2026", "stars" => 5, "text" => "Bakalan mantau sampe end"]
    ],
    5 => [
...
// 5. Validasi pengambilan data spesifik sesuai ID
if (array_key_exists($id_buku, $database_buku)) {
    ...
    $reviews_buku = $database_reviews[4];
}
?>
...
<head>
    ...
    <style>
        /* CSS Tambahan khusus Tombol Aksi Detail Aktif sesuai Mockup */
        .detail-left-column .btn-action-user-container {
            display: flex;
        ...
        .btn-write-review-active:hover {
            background-color: #f1f5f9;
            color: #1e293b;
        }

        /* Normalisasi bobot teks tag genre */
        .spec-tag {
...
<body>
    ...
    <!-- NAVBAR UTAMA (MODE USER LOGGED IN) -->
    <nav class="navbar">
    ...
    <main class="container detail-section">
        ...
        <a href="books_user.php" class="btn-back">
            <i class="fa-solid fa-chevron-left"></i> Back
        </a>

        <div class="book-detail-wrapper">
            
            <!-- SISI KIRI: SAMPUL & TOMBOL AKTIF USER -->
            <div class="detail-left-column">
                ...
                <div class="btn-action-user-container">
                    <button class="btn-add-wishlist-active" onclick="location.href='add_wishlist.php?id=<?php echo $id_buku; ?>'">Add to Wishlist</button>
                    <button class="btn-write-review-active" onclick="location.href='write_review.php?id=<?php echo $id_buku; ?>'">Write Review</button>
                </div>
            </div>

            <!-- SISI KANAN: SPESIFIKASI DAN DATA INNER BUKU -->
            <div class="detail-right-column">
                ...
                <!-- SEKSYEN USER REVIEWS DINAMIS -->
                <div class="reviews-section">
                    <div class="reviews-header">
                        <h3>User Reviews</h3>
                        <span class="showing-count">Showing <?php echo count($reviews_buku); ?> of 30 reviews</span>
                    </div>
        ...
        <div class="similar-books-section">
            ...
            <div class="similar-grid">
                <div class="similar-card">
                    <img src="assets/images/books/similar.png" alt="Book" onerror="this.src='https://via.placeholder.com/150x220?text=It+Starts+With+Us'">
                    <h4>Tittle Book</h4>
                    <p>author name</p>
                </div>
                <div class="similar-card">
